...
class Inception3(nn.Module):
    def __init__(
        ...
        self.Conv2d_1a_3x3 = conv_block(3, 32, kernel_size=3, stride=2)  # 299 x 299 x 3
...
class InceptionB(nn.Module):
    def __init__(self, in_channels: int, conv_block=None) -> None:
        super().__init__()
        if conv_block is None:
            conv_block = BasicConv2d
...
class InceptionC(nn.Module):
    def __init__(
        self, in_channels: int, channels_7x7: int, conv_block=None
    ) -> None:
        super().__init__()
        if conv_block is None:
            conv_block = BasicConv2d
...
class InceptionAux(nn.Module):
    def __init__(
        self, in_channels: int, num_classes: int, conv_block=None
    ) -> None:
        super().__init__()
        if conv_block is None:
            conv_block = BasicConv2d
...
def inception_v3(pretrained=False, **kwargs):
    ...
    if pretrained:
        load_pretrained_model(model, "inception_v3")
    return model
